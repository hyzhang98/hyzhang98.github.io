...
- \[<font color=red>Ongoing</font>\] We are organizing a special issue, **Beneficial Noise Processing in Multimodal Signal Processing**, on **Signal Processing** (Impact Factor = 3.6), where I'm the **Executive Guest Editor**. The homepage is [here](https://www.sciencedirect.com/special-issue/329018/beneficial-noise-processing-noise-learning-multimodal-signal-processing). Welcome to submit your manuscripts about noise to our special issue. If you have any questions about our special issues, please feel free to contact me (hyzhang98@gmail.com).
